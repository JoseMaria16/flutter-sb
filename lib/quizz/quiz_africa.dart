...
import 'package:travel_sb/quizz_class/q_africa.dart';
import 'package:travel_sb/quizz_class/question_africa.dart';
import 'package:travel_sb/widget/app_large_text.dart';

class QuizzAfrica extends StatefulWidget {
  const QuizzAfrica({super.key});

  @override
  State<QuizzAfrica> createState() => _QuizzAfricaState();
}

class _QuizzAfricaState extends State<QuizzAfrica> {
  ...
  Future<void> readJson() async {
    final String response = await rootBundle.loadString('assets/africa.json');
        ...
        children: [
         Container(
          ...
          children: [
            ...
            //  AppLargeText(text: 'Afica-Asia'),
            Text('Africa-Asia', style: TextStyle(
              fontSize: 35,
              color: Colors.deepOrangeAccent
            ),)
          ],
...
class ResultsAfrica extends StatelessWidget {
  const ResultsAfrica({super.key, required this.quiz});
  final Quiz quiz;
