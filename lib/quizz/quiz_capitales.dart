// ignore_for_file: avoid_unnecessary_containers, prefer_const_constructors, non_constant_identifier_names, no_leading_underscores_for_local_identifiers, unused_element

import 'package:flutter/material.dart';
import 'package:flutter/services.dart';
import 'dart:convert';

import 'package:travel_sb/quizz_class/q_capitales.dart';
import 'package:travel_sb/quizz_class/question__capi.dart';
import 'package:travel_sb/widget/app_large_text.dart';

class QuizzCapitales extends StatefulWidget {
  const QuizzCapitales({super.key});

  @override
  State<QuizzCapitales> createState() => _QuizzCapitalesState();
}

class _QuizzCapitalesState extends State<QuizzCapitales> {
  ...
  Widget _buildResultDialog(BuildContext context) {
    return AlertDialog(
      ...
      backgroundColor: Color(0xFF5882FA),
      content: Column(
        ...
        TextButton(
            onPressed: () {
              ...
              Navigator.pushReplacement(
                  context,
                  MaterialPageRoute(
                      builder: ((context) => ResultsCapitales(
                            quiz: quiz,
                          ))));
            },
...
class ResultsCapitales extends StatelessWidget {
  const ResultsCapitales({super.key, required this.quiz});
  final Quiz quiz;
