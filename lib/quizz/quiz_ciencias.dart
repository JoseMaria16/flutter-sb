...
import 'package:travel_sb/quizz_class/q_ciencias.dart';
import 'package:travel_sb/quizz_class/question_ciencias.dart';
import 'package:travel_sb/widget/app_large_text.dart';

class QuizzCiencias extends StatefulWidget {
  const QuizzCiencias({super.key});

  @override
  State<QuizzCiencias> createState() => _QuizzCienciasState();
}

class _QuizzCienciasState extends State<QuizzCiencias> {
  ...
  Future<void> readJson() async {
    final String response = await rootBundle.loadString('assets/ciencias.json');
        ...
        TextButton(
            onPressed: () {
              ...
              Navigator.pushReplacement(
                  context,
                  MaterialPageRoute(
                      builder: ((context) => ResultsCiencias(
                            quiz: quiz,
                          ))));
            },
...
class ResultsCiencias extends StatelessWidget {
  const ResultsCiencias({super.key, required this.quiz});
  final Quiz quiz;
