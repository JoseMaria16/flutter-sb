...
import 'package:travel_sb/quizz_class/q_europa.dart';
import 'package:travel_sb/quizz_class/question_europa.dart';
import 'package:travel_sb/widget/app_large_text.dart';

class QuizzEuropa extends StatefulWidget {
  const QuizzEuropa({super.key});

  @override
  State<QuizzEuropa> createState() => _QuizzEuropaState();
}

class _QuizzEuropaState extends State<QuizzEuropa> {
  ...
  Future<void> readJson() async {
    final String response = await rootBundle.loadString('assets/europa.json');
        ...
        children: [
         Container(
          ...
          children: [
            ...
            //  AppLargeText(text: 'Europa'),
            Text('Europa', style: TextStyle(
              fontSize: 35,
              color: Colors.purple
            ),)
          ],
...
class ResultsEuropa extends StatelessWidget {
  const ResultsEuropa({super.key, required this.quiz});
  final Quiz quiz;
